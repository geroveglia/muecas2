      <section class="section_02_detalle section_02_detalle_chocolate">
        <div class="d-flex flex-column justify-content-center align-items-center">
          ...
          <div class="d-flex justify-content-center section_02_button gs_reveal gs_reveal_fromBottom3">
            <a href="https://www.muecascaba.com.ar/productos/chocolate-muecas-80grs-71-cacao-almendras-tostadas-sal-marina/" target="_blank" class="btn btn_custom_outline_light ps-4 pe-4 fw-bold">Comprame</a>
          </div>
        </div>
      </section>
      <!-- article_03_detalle -->
      <article class="article_03_detalle pt-5 pb-5 mb-5">
        <div class="container pt-3 ps-3 pe-3 pt-5">
          <div class="d-flex flex-column flex-md-row pt-5">
            <div class="col-md-6 d-flex align-items-center justify-content-start justify-content-md-center gs_reveal gs_reveal_fromLeft pb-4 pb-lg-0 mb-5 mb-md-0">
              <p class="custom_font_color_alfajor secondary_font">equilibrio<br />perfecto con 71%<br />cacao, algo dulce<br />y un toque de sal<br />marina</p>
            </div>
            <div class="col-md-6 d-flex align-items-center justify-content-center gs_reveal gs_reveal_fromRight">
              <div class="article_03_detalle_nuevo-container">
                <img class="article_03_detalle_nuevo-container-etiqueta-chocolate" src="./assets/images/index_section_06_nuevo.svg" alt="image" />
                <img class="img-fluid floatAnimation mt-4" src="./assets/images/detalle_article_03_img_chocolate.webp" alt="producto chocolate" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="d-flex flex-column justify-content-center align-items-center">
            <div class="d-flex flex-column flex-md-row justify-content-center align-items-center pt-1 pt-md-1">
              <div class="mb-2 mb-md-0">
                <h2 class="secondary_font custom_font_color_alfajor text-center gs_reveal gs_reveal_fromLeft">almendra +<br />sal marina</h2>
              </div>
              ...
              <div class="col-2 gs_reveal gs_reveal_fromRight">
                <img class="img-fluid pe-md-3" src="./assets/images/detalle_section_04-abp.webp" alt="abp" />
              </div>
            </div>
            <div>
                  ...
                  <div class="modal-content-alfajor">
                    <div class="modal-header">
                      <div>
                        ...
                        <div>
                          <h5 class="modal-title" id="exampleModalLabel">Chocolate a base de plantas</h5>
                        </div>
                      </div>
              ...
              <span class="stretched-link">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">"Lo acabo de probar y no puede más de Rico".</p>
                  </div>
                </div>
              </span>
            </div>
            <div class="mt-5">
              <span class="stretched-link">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title m-0"></h5>
                    <p class="card-text">"Excelente! Me encanto, es riquisimo!".</p>
                  </div>
                </div>
              </span>
            </div>
