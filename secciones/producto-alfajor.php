      <section class="section_02_detalle section_02_detalle_alfajor">
        <div class="d-flex flex-column justify-content-center align-items-center">
          ...
          <div class="d-flex justify-content-center section_02_button gs_reveal gs_reveal_fromBottom3">
            <a href="https://www.muecascaba.com.ar/productos/alfajor-muecas-60grs-cacao-ddl-de-coco-mantequilla-de-mani/" target="_blank" class="btn btn_custom_outline_light ps-4 pe-4 fw-bold">Comprame</a>
          </div>
        </div>
      </section>
      <!-- article_03_detalle -->
      <article class="article_03_detalle pt-5 pb-0 pb-lg-5">
        <div class="container pt-3 ps-3 pe-3 pt-5">
          <div class="d-flex flex-column flex-md-row pt-xl-5">
            <div class="col-md-6 d-flex align-items-center justify-content-start justify-content-md-center gs_reveal gs_reveal_fromLeft pb-4 pb-lg-0">
              <p class="custom_font_color_alfajor secondary_font">un alfajor con un<br />sabor único,<br />relleno de cacao,<br />dulce de coco y<br />pasta de maní</p>
            </div>
            <div class="col-md-6 d-flex align-items-center justify-content-center gs_reveal gs_reveal_fromRight">
              <div class="article_03_detalle_nuevo-container">
                <img class="article_03_detalle_nuevo-container-etiqueta" src="./assets/images/index_section_06_nuevo.svg" alt="circulo nuevo"" />
                <img class="img-fluid p-5 floatAnimation mt-4" src="./assets/images/detalle_article_03_img_alfajor.webp" alt="producto alfajor" />
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- section_04_detalle -->
      <section class="section_04_detalle pb-5">
        <div class="container">
          <div class="d-flex flex-column justify-content-center align-items-center">
            <div class="d-flex flex-column flex-md-row justify-content-center align-items-center pt-1 pt-md-1">
              <div class="mb-2 mb-md-0">
                <h2 class="secondary_font custom_font_color_alfajor text-center gs_reveal gs_reveal_fromLeft">
                  cacao, dulce<br />
                  de coco +<br />pasta de maní
                </h2>
              </div>
              <div class="ms-5 me-5 d-none d-md-block">
                <img class="img-fluid gs_reveal gs_reveal_fromBottom1" src="./assets/images/detalle_section_04-kosher-separador.svg" alt="separador" />
              </div>
              <div class="col-2 gs_reveal gs_reveal_fromRight">
                <img class="img-fluid pe-md-3" src="./assets/images/detalle_section_04-abp.webp" alt="abp logo" />
              </div>
            </div>
            <div>
              <div class="pt-4 pt-md-5 gs_reveal gs_reveal gs_reveal_fromBottom3">
                <!-- Button trigger modal -->
                <button type="button" class="btn btn_custom_outline_dark ps-3 pe-3 fw-bold" data-bs-toggle="modal" data-bs-target="#exampleModal">Ver tabla nutricional</button>
              </div>
              <!-- Modal -->
              <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable">
                  <div class="modal-content-alfajor">
                    <div class="modal-header">
                      <div>
                        <div>
                          <img class="navbar-brand img-fluid m-0" src="./assets/images/detalle_section_04-logo-modal.svg" alt="logo marca" />
                        </div>
                        <div>
                          <h5 class="modal-title" id="exampleModalLabel">Alfajor a base de plantas</h5>
                        </div>
                      </div>
                    ...
                    <div class="modal-body">
                      <div>
                        <div>
                          <h5 class="m-0">Información nutricional</h5>
                          <p>Porción 45 g. 1 Barrita</p>
                          <div class="container p-0 m-0">
                            <table class="table table-bordered table-striped section_04_detalle_custom_table text-center">
                              <thead>
                                <tr>
                                  <th scope="col"></th>
                                  <th scope="col" class="text-center">1 porción</th>
                                  <th scope="col" class="text-center">%VD*</th>
                                </tr>
                              </thead>
                              <tbody class="text-center">
                                <tr>
                                  <th scope="row">Valor energético</th>
                                  <td>229 kcal = 958 kJ</td>
                                  <td>11 %</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <th scope="row">Azúcares totales</th>
                                  <td>16 g</td>
                                  <td>-</td>
                                </tr>
                                <tr>
                                  <th scope="row">Azúcares añadidos</th>
                                  <td>16 g</td>
                                  <td>-</td>
                                </tr>
                                <tr>
                        ...
                        <div>
                          <p class="section_04_detalle_modal_valores">*Valores diarios de producto listo para consumir con base a una dieta de 2000 Kcal u 8400 KJ. Sus valores diarios pueden ser mayores o menores dependiendo de sus necesidades energéticas.</p>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <!-- section_05_detalle -->
      <section class="section_05_detalle pt-5 pb-5">
        <div class="container p-2 col-md-9 pt-5 pb-5">
          <div class="text-center mb-3 gs_reveal gs_reveal_fromUp">
            <h2 class="custom_font_color_alfajor pb-3 secondary_font">#comunidad</h2>
          </div>
          <div class="owl-carousel owl-theme owl-comunidad gs_reveal">
            <div class="mt-5">
              <span class="stretched-link">
                <div class="section_05_detalle_card_circulo">
                  <img src="./assets/images/detalle_section_05_circulo-alfajor.webp" alt="icono comunidad" />
                </div>
                <div class="card">
                  <div class="card-header"></div>
                  <div class="card-body">
                    <h5 class="card-title m-0"></h5>
                    <p class="card-text">"Qué delicia, felicitaciones y gracias por hacernos tan felices".</p>
                  </div>
                </div>
              </span>
            </div>
            <div class="mt-5">
              <span class="stretched-link">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title m-0"></h5>
                    <p class="card-text">"El alfajor a base de plantas es la cosa más rica que comí en mi vida. Tuve que buscar su pagina para decirlo porque es increible".</p>
                  </div>
                </div>
              </span>
            </div>
            <div class="mt-5">
              <span class="stretched-link">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title m-0"></h5>
                    <p class="card-text">"Que cosa mas rica por favor! No puede ser más rico".</p>
                  </div>
                </div>
              </span>
            </div>
