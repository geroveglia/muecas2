      <!-- section_02_detalle -->
      <section class="section_02_detalle section_02_detalle_violeta">
        <div class="d-flex flex-column justify-content-center align-items-center">
          <div class="gs_reveal gs_reveal_fromUp">
            <h2 class="p-2">Barrita Violeta</h2>
          </div>
          <div class="mb-4">
          ...
          <div class="d-flex justify-content-center section_02_button gs_reveal gs_reveal_fromBottom3">
            <a href="https://www.muecascaba.com.ar/productos/caja-16-muecas-pasas-y-almendras-45grs/" target="_blank" class="btn btn_custom_outline_light ps-4 pe-4 fw-bold">Comprame</a>
          </div>
        </div>
      </section>
      <!-- article_03_detalle -->
        ...
        <div class="container pt-3 ps-3 pe-3 pt-5">
          <div class="d-flex flex-column flex-md-row">
            <div class="col-md-6 d-flex align-items-center justify-content-start justify-content-md-center gs_reveal gs_reveal_fromLeft pb-4 pb-lg-0">
              <p class="custom_font_color_violeta secondary_font">un buen<br />momento se<br />construye de<br />pocos elementos</p>
            </div>
            <div class="col-md-6 d-flex align-items-center justify-content-center gs_reveal gs_reveal_fromRight mt-4">
              <img class="floatAnimation" src="./assets/images/detalle_article_03_img_violeta.webp" alt="producto barrita rosa" />
            </div>
          </div>
        </div>
      </article>
          ...
          <div class="d-flex flex-column justify-content-center align-items-center">
            <div class="d-flex flex-column flex-md-row justify-content-center align-items-center pt-1 pt-md-1">
              <div class="mb-2 mb-md-0">
                <h2 class="secondary_font custom_font_color_violeta text-center gs_reveal gs_reveal_fromLeft">
                  pasas +<br />
                  almendras
                </h2>
              </div>
            ...
            <div>
              ...
              <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable">
                  <div class="modal-content-violeta">
                    <div class="modal-header">
                      <div>
                        ...
                        <div>
                          <h5 class="modal-title" id="exampleModalLabel">Barra de pasas y almendras</h5>
                        </div>
                      </div>
      ...
      <section class="section_05_detalle pt-5 pb-5">
        <div class="container p-2 col-md-9 pt-5 pb-5">
          <div class="text-center mb-3 gs_reveal gs_reveal_fromUp">
            <h2 class="custom_font_color_violeta pb-3 secondary_font">#comunidad</h2>
          </div>
            ...
            <div class="mt-5">
              <span class="stretched-link">
                <div class="section_05_detalle_card_circulo">
                  <img src="./assets/images/detalle_section_05_circulo-violeta.webp" alt="icono comunidad" />
                </div>
                <div class="card">
                  <div class="card-header"></div>
                  <div class="card-body">
                    <h5 class="card-title m-0"></h5>
                    <p class="card-text">"Me salvan la merienda, especiales".</p>
                  </div>
                </div>
              </span>
            </div>
            <div class="mt-5">
              <span class="stretched-link">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title m-0"></h5>
                    <p class="card-text">"Son un 10, riquísimas y te salvan de esos momentos de apuros".</p>
                  </div>
                </div>
              </span>
            </div>
            <div class="mt-5">
              <span class="stretched-link">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title m-0"></h5>
                    <p class="card-text">"Una de mis debilidades".</p>
                  </div>
                </div>
              </span>
            </div>
