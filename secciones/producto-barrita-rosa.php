      <section class="section_02_detalle section_02_detalle_rosa">
        <div class="d-flex flex-column justify-content-center align-items-center">
          <div class="gs_reveal gs_reveal_fromUp">
            <h2 class="p-2">Barrita Rosa</h2>
          </div>
          <div class="mb-4">
          ...
          <div class="d-flex justify-content-center section_02_button gs_reveal gs_reveal_fromBottom3">
            <a href="https://www.muecascaba.com.ar/productos/caja-16-muecas-cacao-y-avellanas-45grs/" target="_blank" class="btn btn_custom_outline_light ps-4 pe-4 fw-bold">Comprame</a>
          </div>
        </div>
      </section>
      <!-- article_03_detalle -->
        ...
        <div class="container pt-3 ps-3 pe-3 pt-5">
          <div class="d-flex flex-column flex-md-row">
            <div class="col-md-6 d-flex align-items-center justify-content-start justify-content-md-center gs_reveal gs_reveal_fromLeft pb-4 pb-lg-0">
              <p class="custom_font_color_rosa secondary_font">la mejor opción<br />para bajar un<br />cambio</p>
            </div>
            <div class="col-md-6 d-flex align-items-center justify-content-center gs_reveal gs_reveal_fromRight mt-4">
              <img class="floatAnimation" src="./assets/images/detalle_article_03_img_rosa.webp" alt="producto barrita rosa" />
            </div>
          </div>
        </div>
      </article>
          ...
          <div class="d-flex flex-column justify-content-center align-items-center">
            <div class="d-flex flex-column flex-md-row justify-content-center align-items-center pt-1 pt-md-1">
              <div class="mb-2 mb-md-0">
                <h2 class="secondary_font custom_font_color_rosa text-center gs_reveal gs_reveal_fromLeft">
                  cacao +<br />
                  avellanas
                </h2>
              </div>
                  ...
                  <div class="modal-content-rosa">
                    <div class="modal-header">
                      <div>
                        ...
                        <div>
                          <h5 class="modal-title" id="exampleModalLabel">Barra de cereal,cacao y avellanas</h5>
                        </div>
                      </div>
      ...
      <section class="section_05_detalle pt-5 pb-5">
        <div class="container p-2 col-md-9 pt-5 pb-5">
          <div class="text-center mb-3 gs_reveal gs_reveal_fromUp">
            <h2 class="custom_font_color_rosa pb-3 secondary_font">#comunidad</h2>
          </div>
            ...
            <div class="mt-5">
              <span class="stretched-link">
                <div class="section_05_detalle_card_circulo">
                  <img src="./assets/images/detalle_section_05_circulo-rosa.webp" alt="icono comunidad" />
                </div>
                <div class="card">
                  <div class="card-header"></div>
                  <div class="card-body">
                    <h5 class="card-title m-0"></h5>
                    <p class="card-text">"Amo sus barritas y estoy muy feliz de que existan, las de cacao y avellanas son un viaje de ida, las como todos los días, son re cracks".</p>
                  </div>
                </div>
              </span>
            </div>
            <div class="mt-5">
              <span class="stretched-link">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title m-0"></h5>
                    <p class="card-text">"Rosita! Sin vos mis cambios de hora en la facu serían una desgracia".</p>
                  </div>
                </div>
              </span>
            </div>
            <div class="mt-5">
              <span class="stretched-link">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title m-0"></h5>
                    <p class="card-text">"La probé y juro que cambio un chocolate por una de estas".</p>
                  </div>
                </div>
              </span>
            </div>
