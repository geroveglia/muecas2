...
<div class="normalheader transition animated fadeIn small-header">
  <div class="hpanel">
    <div class="panel-body">
      <h2>
        Franjas horarias <!--<a href="./?seccion=franjas_new&nc=<?php echo $rand;?>" class="btn btn-warning btn-xs"><i class="fa fa-plus"></i></a>-->
      </h2>
    </div>
  </div>
</div>
      ...
      <div class="hpanel">
        <div class="panel-body">
          ...
          <tr role="row">
            ...
            <th>Cantidad m&aacute;xima de cajas</th>
            <th></th>
          </tr>
          </thead>
          <tbody>
            <?php
            $consulta = "SELECT * FROM franjas";
            ...
            echo '
              <tr>
                <td>'.$rArray['Id'].'</td>
                <td>'.$rArray['franja'].'</td>
                <td>'.$rArray['maximo_cajas'].'</td>
                <td>
                <a href="./?seccion=franjas_edit&id='.$rArray['Id'].'&nc='.$rand.'" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
                </td>
              </tr>
            ';
            }
    ...
    <script>
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'excel', title: 'Franjas horarias'},
                    {extend: 'pdf', title: 'Franjas horarias'},
                    {extend: 'print',
                     text: 'IMPRIMIR',
