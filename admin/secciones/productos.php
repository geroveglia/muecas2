...
<div class="normalheader transition animated fadeIn small-header">
  <div class="hpanel">
    <div class="panel-body">
      <h2>
        Productos <a href="./?seccion=productos_new&nc=<?php echo $rand;?>" class="btn btn-warning btn-xs"><i class="fa fa-plus"></i></a>
      </h2>
    </div>
  </div>
</div>
          ...
          <tbody>
            ...
            echo '
              <tr>
                <td>'.$rArray['Id'].'</td>
                <td>'.$rArray['nombre'].'</td>
                <td>'.$rArray['lote_id'].'</td>
                <td>
                '.(($_SESSION["tipo"]!='Visualizador')?'
                <a href="./?seccion=productos_edit&id='.$rArray['Id'].'&nc='.$rand.'" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
                <a href="./?seccion=productos_delete&id='.$rArray['Id'].'&nc='.$rand.'" class="btn btn-warning btn-xs"><i class="fa fa-trash-o"></i></a>
                ':'').'
                </td>
              </tr>
            ';
