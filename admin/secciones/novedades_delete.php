      ...
      <div class="hpanel">
        ...
        <?php
          ...
          if($confirmar == 'si'){
            ...
            <div class="pull-right">
              <a href="?seccion=novedades_delete&id='.$id.'&confirmar=si&nc='.$rand.'" class="btn btn-warning">Eliminar</a>
              <a href="?seccion=novedades&nc='.$rand.'" class="btn btn-warning">Cancelar</a>
            </div>';
          }
        ?>
        </div>
