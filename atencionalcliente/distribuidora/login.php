...
if($_POST['email']!='' && $_POST['contrasenia']!=''){
  ...
  $consulta = "SELECT * FROM clientes WHERE email='$email' AND contrasenia='$contrasenia' AND activo='1' AND tipo = 'distribuidor'";
...
if ($_SESSION["login"] == 'si') {
    if ($_SESSION["redir"] != '') {
        ...
        header("location: index.php?nc=" . $rand); // Cambia aquí a index2.php
    }
}
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <!-- Page title -->
    <title>Muecas - Distribuidora</title>
    ...
    <div class="login-container">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          Si quiere darse de alta en la plataforma de reclamos deben comunicarse con <strong>calidad@muecas.com.ar </strong>
        </div>
      </div>
      <div class="row m-t">
